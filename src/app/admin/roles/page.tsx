...
const roles = [
  {
    id: "agent",
    name: "Партнёр",
    description: "Работа с лидами, коммуникации с клиентами, просмотр финансов",
    permissions: ["Просмотр своих лидов", "Чат с клиентами", "Просмотр финансов", "Управление профилем", "Загрузка документов"],
    usersCount: 3,
    color: "info" as const,
  },
  {
    id: "manager",
    name: "Менеджер",
    description: "Управление партнёрами, распределение лидов, мониторинг коммуникаций",
    permissions: ["Управление партнёрами", "Все лиды", "Все диалоги", "Рассылки", "Финансы", "Документы"],
    usersCount: 2,
