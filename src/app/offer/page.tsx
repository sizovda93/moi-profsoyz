    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="max-w-4xl mx-auto px-6 py-12">
        ...
        <div className="prose prose-invert prose-sm max-w-none space-y-4 text-muted-foreground">
          <p>Настоящая публичная оферта (далее — «Оферта») определяет условия использования платформы Мой Профсоюз (далее — «Платформа»).</p>
          <h2 className="text-lg font-medium text-foreground mt-8">1. Общие положения</h2>
          <p>1.1. Платформа предоставляет сервис для взаимодействия членов профсоюза, подачи обращений, обмена документами и обучения.</p>
          ...
          <p>2.1. Организация предоставляет Пользователю доступ к функциональности Платформы.</p>
