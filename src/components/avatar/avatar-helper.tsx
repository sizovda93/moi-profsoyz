...
const questions: AvatarQuestion[] = [
  ...
  {
    id: "q4",
    label: "Где пройти обучение?",
    video: "/avatar/answer-q2.webm",
    answerText:
      "Откройте раздел Обучение в левом меню. Там вы найдёте курсы по трудовым правам, работе с платформой и документами. Каждый урок можно пройти за несколько минут. После прохождения обязательных модулей ваш профиль будет отмечен как обученный.",
  },
  {
    id: "q5",
